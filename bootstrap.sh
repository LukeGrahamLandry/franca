...
mv "src/bootstrap_gen.rs" "target/bootstrap_gen.rs.temp" || {
...
mv "lib/codegen/aarch64/basic.gen.fr" "target/aarch64_basic.gen.fr.temp" || {
   ...
   mv "target/bootstrap_gen.rs.temp" "src/bootstrap_gen.rs"
   exit 1;
}

mv "target/bootstrap_gen.rs" "src/bootstrap_gen.rs"
...
RUST_BACKTRACE=1 cargo run || {
  ...
  diff "target/bootstrap_gen.rs.temp" "src/bootstrap_gen.rs" &> "target/bootstrap_gen.rs.diff"
  diff "target/aarch64_basic.gen.fr.temp" "lib/codegen/aarch64/basic.gen.fr" &> "target/aarch64_basic.gen.fr.diff"
  mv "src/bootstrap_gen.rs" "target/bootstrap_gen.rs.failed"
