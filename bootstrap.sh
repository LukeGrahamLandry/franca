RUST_BACKTRACE=1 RUST_MIN_STACK=8388608 cargo test -p compiler -p llvm-backend || {
...
mv "crates/compiler/src/experiments/bootstrap_gen.rs" "target/bootstrap_gen.rs.temp" || {
...
mv "lib/codegen/aarch64/basic.gen.fr" "target/aarch64_basic.gen.fr.temp" || {
   ...
   mv "target/bootstrap_gen.rs.temp" "crates/compiler/src/experiments/bootstrap_gen.rs"
   exit 1;
}

mv "target/bootstrap_gen.rs" "crates/compiler/src/experiments/bootstrap_gen.rs"
...
RUST_BACKTRACE=1 RUST_MIN_STACK=8388608 cargo test -p compiler -p llvm-backend || {
  ...
  diff "target/bootstrap_gen.rs.temp" "crates/compiler/src/experiments/bootstrap_gen.rs" &> "target/bootstrap_gen.rs.diff"
  diff "target/aarch64_basic.gen.fr.temp" "lib/codegen/aarch64/basic.gen.fr" &> "target/aarch64_basic.gen.fr.diff"
  mv "crates/compiler/src/experiments/bootstrap_gen.rs" "target/bootstrap_gen.rs.failed"
