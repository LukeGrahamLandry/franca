...
- not constantly doing string comparisons makes it feel a lot less fragile. 
...
- allow #use with non-GetVar-expr
- fix apple_arm_subword_abi.ssa
...
- emit_c: attempt simple cases of FuncImpl.FrcImport 
  so can turn off DISABLE_IMPORT_FRC and build the whole compiler. 
