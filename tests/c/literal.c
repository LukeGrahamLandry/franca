...
int main() {
  ASSERT(97, 'a');
  ASSERT(10, '\n');
  ASSERT(-128, '\x80');  // '' is an int but sign extended from a byte
  ...
  ASSERT(-1, 18446744073709551615>>63);  // TODO: clang doesn't agree unless you add (long) on the front
