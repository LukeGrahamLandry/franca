...
- connect the circuit rendering to the logic ones so can show wire values, etc. need to track index mapping because gates are reordered. 
- clean up builtin.fr code
